      ...
      <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-900">Trade Plan</h1>
              <p className="text-sm text-gray-600 leading-tight">Trading strategies and risk management guidelines</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            {strategies.map((strategy, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${strategy.risk === 'High' ? 'bg-red-100 text-red-800' :
       ...
       <div className="mt-8 bg-yellow-100 border-t border-yellow-300 text-gray-800 text-sm p-4 shadow-md rounded-md">
          <div className="max-w-7xl mx-auto flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-semibold text-yellow-800">Important Disclaimer</h3>
              <div className="mt-1 text-xs text-yellow-700 space-y-1">
                <p>
                  Trading in financial markets involves substantial risk of loss and is not suitable for all investors. The strategies and information provided here are for educational purposes only.
                </p>
                <p>
                  Past performance does not guarantee future results. Always consult with a qualified financial advisor before making investment decisions and ensure you understand the risks involved.
                </p>
              </div>
            </div>
          </div>
