...
import { Eye, EyeOff, Mail, Lock, User, BarChart3, ArrowRight, Shield, Zap, CheckCircle } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      description: "Get started with zero setup fees"
    },
    {
      icon: Shield,
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Join our community of successful traders and unlock your potential with AI-powered insights
            </p>
          </div>
